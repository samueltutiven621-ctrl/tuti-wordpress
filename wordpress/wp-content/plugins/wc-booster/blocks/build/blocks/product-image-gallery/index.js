...
/***/ "./src/blocks/product-image-gallery/components/edit.js":
/*!*************************************************************!*\
  !*** ./src/blocks/product-image-gallery/components/edit.js ***!
  \*************************************************************/
...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../styles/editor.scss */ "./src/blocks/product-image-gallery/styles/editor.scss");
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./inspector */ "./src/blocks/product-image-gallery/components/inspector.js");
...
// Sample
// https://themes.shopify.com/themes/shark/styles/bright/preview?surface_detail=themes-grid-first-row&surface_inter_position=1&surface_intra_position=2&surface_type=home

const Edit = props => {
  const [thumbnailSlider, setThumbnailSlider] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const [imageSlider, setImageSlider] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  let imageSliderRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  let thumbnailSliderRef = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(null);
  const {
    attributes: {
      saleText,
      saleTextColor,
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    setImageSlider(imageSliderRef);
    setThumbnailSlider(thumbnailSliderRef);
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_4__.prefix}-product-image-gallery-${blockProps.id}`
    });
  }, []);
  const image = "https://placehold.co/600x700";
  const thumbnail = "https://placehold.co/120x120";
  const Next = props => {
    const {
      className,
      style,
  ...
  const sliderCount = [0, 1, 2, 3, 4, 5];
  const saleStyle = {
    backgroundColor: saleBgColor,
    color: saleTextColor,
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_8__.getTypoStyle)(saleTypo)
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_helpers__WEBPACK_IMPORTED_MODULE_8__.isSingleProductTemplate)() ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: `${_constants__WEBPACK_IMPORTED_MODULE_4__.prefix}-thumbnail`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_slick__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ref: slider => thumbnailSliderRef = slider,
    ...thumbnailSliderSetting
  }, sliderCount.map(i => {
    ...
    className: `${_constants__WEBPACK_IMPORTED_MODULE_4__.prefix}-main-image`
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_slick__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ref: slider => imageSliderRef = slider,
    ...imageSliderSetting
  }, sliderCount.map(i => {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: i
    ...
    className: "wc-booster-save-badge",
    style: saleStyle
  }, saleText)), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inspector__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...props
  })) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...blockProps
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "wc-booster-single-product-block-notice"
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('This block is intended for the single product template only.', 'woo-booster'))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Edit);

/***/ }),

/***/ "./src/blocks/product-image-gallery/components/inspector.js":
/*!******************************************************************!*\
  !*** ./src/blocks/product-image-gallery/components/inspector.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _custom_control_responsive_range_wrapper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../custom-control/responsive-range-wrapper */ "./src/custom-control/responsive-range-wrapper.js");
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../block.json */ "./src/blocks/product-image-gallery/block.json");
...
const InspectorPanel = props => {
  ...
  const def = (0,_helpers__WEBPACK_IMPORTED_MODULE_5__.getDefaultAttr)(_block_json__WEBPACK_IMPORTED_MODULE_7__);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Sale Badge", "wc-booster"),
    initialOpen: true
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Text", "wc-booster"),
    value: saleText,
    onChange: saleText => setAttributes({
      saleText
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control_typography__WEBPACK_IMPORTED_MODULE_6__["default"], {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Sale", "wc-booster"),
    value: saleTypo,
    defaultValue: _block_json__WEBPACK_IMPORTED_MODULE_7__.attributes.saleTypo["default"],
    onChange: saleTypo => setAttributes({
      saleTypo
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_8__.PanelColor, {
    colorSettings: [{
      value: saleTextColor,
      onChange: saleTextColor => setAttributes({
        saleTextColor
      }),
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Text Color", "wc-booster")
    }, {
      value: saleBgColor,
      onChange: saleBgColor => setAttributes({
        saleBgColor: (0,_helpers__WEBPACK_IMPORTED_MODULE_5__.isUndefined)(saleBgColor) ? "" : saleBgColor
      }),
...
/***/ "./src/blocks/product-image-gallery/index.js":
/*!***************************************************!*\
  !*** ./src/blocks/product-image-gallery/index.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./block.json */ "./src/blocks/product-image-gallery/block.json");
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/product-image-gallery/components/edit.js");
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./styles/style.scss */ "./src/blocks/product-image-gallery/styles/style.scss");
...
(0,_helpers___WEBPACK_IMPORTED_MODULE_1__.register)(_block_json__WEBPACK_IMPORTED_MODULE_2__.name, {
...
/***/ "./src/blocks/product-image-gallery/styles/editor.scss":
/*!*************************************************************!*\
  !*** ./src/blocks/product-image-gallery/styles/editor.scss ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/product-image-gallery/styles/style.scss":
/*!************************************************************!*\
  !*** ./src/blocks/product-image-gallery/styles/style.scss ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/product-image-gallery/block.json":
/*!*****************************************************!*\
  !*** ./src/blocks/product-image-gallery/block.json ***!
  \*****************************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wc-booster/product-image-gallery","version":"1.0","title":"Product Image Gallery","description":"The Product Image Gallery Block displays a customizable image slider for WooCommerce products. It supports product variations and offers a responsive, smooth browsing experience on all devices.","supports":{"multiple":false},"attributes":{"block_id":{"type":"string"},"saleText":{"type":"string","default":"Sale!"},"saleTextColor":{"type":"string","default":"#ffffff"},"saleBgColor":{"type":"string","default":"#000"},"saleTypo":{"type":"object","default":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":16,"tablet":16,"mobile":16}},"fontWeight":400,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1.2,"tablet":1.2,"mobile":1.2}}}}},"textdomain":"wc-booster","editorScript":"file:./index.js","viewScript":"file:./gallery-slider.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/product-image-gallery/index": 0,
/******/ 			"blocks/product-image-gallery/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/product-image-gallery/style-index"], () => (__webpack_require__("./src/blocks/product-image-gallery/index.js")))
