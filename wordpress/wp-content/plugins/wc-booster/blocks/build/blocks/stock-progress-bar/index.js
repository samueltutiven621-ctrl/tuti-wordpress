...
/***/ "./src/blocks/stock-progress-bar/components/edit.js":
/*!**********************************************************!*\
  !*** ./src/blocks/stock-progress-bar/components/edit.js ***!
  \**********************************************************/
...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../styles/editor.scss */ "./src/blocks/stock-progress-bar/styles/editor.scss");
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./inspector */ "./src/blocks/stock-progress-bar/components/inspector.js");
...
const Edit = props => {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    className: `${_constants__WEBPACK_IMPORTED_MODULE_5__.prefix}-stock-progress-bar-wrapper ${alignment}`
  });
  const product = wp.data.select("core").getEntityRecord("postType", "product", postId);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_5__.prefix}-stock-progress-bar-${blockProps.id}`
    });
  }, []);
  const manageStock = product?.wc_booster_product_stock_data?.manage_stock;
  const soldStock = product?.wc_booster_product_stock_data?.sold_stock;
  const totalStock = product?.wc_booster_product_stock_data?.total_stock;
  const progressPercentage = totalStock + soldStock > 0 ? soldStock / (soldStock + totalStock) * 100 : 0;
  const textStyle = {
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_7__.getTypoStyle)(textTypo),
    color: textColor
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.AlignmentToolbar, {
    ...
    ...blockProps
  }, !(0,_helpers__WEBPACK_IMPORTED_MODULE_7__.isSingleProductTemplate)() ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, manageStock ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    style: {
      ...
      overflow: "hidden",
      width: "100%",
      height: (0,_helpers__WEBPACK_IMPORTED_MODULE_7__.getResponsiveRangeVal)(height)
    }
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: "stock-progress-bar-fill",
    style: {
    ...
    style: textStyle
  }, `Sold: ${soldStock} / ${soldStock + totalStock}`)) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    style: textStyle
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Stock management is not enabled.", "wc-booster"))) : (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      backgroundColor: "#eee",
      fontSize: "20px",
      textAlign: "center",
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)("Stock Progress Bar", "wc-booster"))));
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Edit);

/***/ }),

/***/ "./src/blocks/stock-progress-bar/components/inspector.js":
/*!***************************************************************!*\
  !*** ./src/blocks/stock-progress-bar/components/inspector.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../block.json */ "./src/blocks/stock-progress-bar/block.json");
...
const InspectorPanel = props => {
  ...
  const def = getDefaultAttr(_block_json__WEBPACK_IMPORTED_MODULE_7__);
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Height", "wc-booster"),
    beforeIcon: ""
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_custom_control__WEBPACK_IMPORTED_MODULE_1__.RadiusControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Border Radius", "wc-booster"),
    value: borderRadius,
    allowReset: false,
    ...
    value: textTypo,
    defaultValue: _block_json__WEBPACK_IMPORTED_MODULE_7__.attributes.textTypo["default"],
    ...
    colorSettings: [{
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Progress Color"),
      value: progressColor,
      onChange: newValue => setAttributes({
        progressColor: newValue
      })
    }, {
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Progress Bar Color"),
...
/***/ "./src/blocks/stock-progress-bar/index.js":
/*!************************************************!*\
  !*** ./src/blocks/stock-progress-bar/index.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/style.scss */ "./src/blocks/stock-progress-bar/styles/style.scss");
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/stock-progress-bar/components/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/stock-progress-bar/block.json");
...
/***/ "./src/blocks/stock-progress-bar/styles/editor.scss":
/*!**********************************************************!*\
  !*** ./src/blocks/stock-progress-bar/styles/editor.scss ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/stock-progress-bar/styles/style.scss":
/*!*********************************************************!*\
  !*** ./src/blocks/stock-progress-bar/styles/style.scss ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/stock-progress-bar/block.json":
/*!**************************************************!*\
  !*** ./src/blocks/stock-progress-bar/block.json ***!
  \**************************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wc-booster/stock-progress-bar","version":"1.3","title":"Stock Progress Bar","description":"This block shows a progress bar indicating the percentage of stock sold, along with the number of units sold out of the total available stock for a product.","attributes":{"block_id":{"type":"string"},"textColor":{"type":"string","default":"#000000"},"progressColor":{"type":"string","default":"#4caf50"},"progressBarColor":{"type":"string","default":"#f2f2f2"},"alignment":{"type":"string","default":"center"},"height":{"type":"object","default":{"activeUnit":"px","units":["px","em"],"range":{"min":1,"max":2000},"values":{"desktop":20,"tablet":20,"mobile":20}}},"textTypo":{"type":"object","default":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":15,"tablet":15,"mobile":15}},"fontWeight":400,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1,"tablet":1,"mobile":1}}}},"borderRadius":{"type":"number","default":10}},"ancestor":["woocommerce/single-product"],"usesContext":["postId"],"textdomain":"wc-booster","editorScript":"file:./index.js","viewScript":"file:./progress-bar.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/stock-progress-bar/index": 0,
/******/ 			"blocks/stock-progress-bar/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/stock-progress-bar/style-index"], () => (__webpack_require__("./src/blocks/stock-progress-bar/index.js")))
