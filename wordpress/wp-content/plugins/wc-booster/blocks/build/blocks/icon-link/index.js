...
/***/ "./src/blocks/icon-link/components/edit.js":
/*!*************************************************!*\
  !*** ./src/blocks/icon-link/components/edit.js ***!
  \*************************************************/
...
/* harmony import */ var _styles_editor_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../styles/editor.scss */ "./src/blocks/icon-link/styles/editor.scss");
...
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./inspector */ "./src/blocks/icon-link/components/inspector.js");
...
const Edit = props => {
  ...
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)({
    className: `${_constants__WEBPACK_IMPORTED_MODULE_5__.prefix}-icon-link-wrapper`
  });
  const allPage = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_9__.useSelect)(select => {
    const {
      getEntityRecords
    } = select("core");
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    setAttributes({
      block_id: `${_constants__WEBPACK_IMPORTED_MODULE_5__.prefix}-icon-link-${blockProps.id}`
    });
  }, []);
  const iconStyle = {
  ...
  const textStyle = {
    ...
    color: textColor,
    ...(0,_helpers__WEBPACK_IMPORTED_MODULE_8__.getDimensionStyle)("margin", titleMargin)
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_inspector__WEBPACK_IMPORTED_MODULE_7__["default"], {
    ...
    className: `fa ${icon.icon ? icon.icon : icon} ${_constants__WEBPACK_IMPORTED_MODULE_5__.prefix}-icon-link-icon`,
    style: iconStyle
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.RichText, {
    className: `${_constants__WEBPACK_IMPORTED_MODULE_5__.prefix}-icon-link-title`,
    tagName: "p",
    value: title,
...
/***/ "./src/blocks/icon-link/components/inspector.js":
/*!******************************************************!*\
  !*** ./src/blocks/icon-link/components/inspector.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../block.json */ "./src/blocks/icon-link/block.json");
...
const InspectorPanel = props => {
  ...
  options = [{
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Select a page", "rise-blocks"),
    value: 0
  }, ...options];
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, {
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Use External Link", "rise-blocks"),
    checked: useExternalLink,
    onChange: newValue => setAttributes({
      useExternalLink: newValue
    })
  ...
  })), !useExternalLink && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.SelectControl, {
    label: "Page",
    value: page,
    options: options,
    onChange: newValue => setAttributes({
  ...
  }), useExternalLink && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.TextControl, {
    value: externalLink,
    placeholder: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Link", "wc-booster"),
    onChange: newValue => setAttributes({
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__.__)("Title Margin", "wc-booster"),
    value: titleMargin,
    defaultValue: _block_json__WEBPACK_IMPORTED_MODULE_8__.attributes.titleMargin["default"],
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _styles_style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/style.scss */ "./src/blocks/icon-link/styles/style.scss");
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/icon-link/components/edit.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./block.json */ "./src/blocks/icon-link/block.json");
...
/***/ "./src/blocks/icon-link/styles/editor.scss":
/*!*************************************************!*\
  !*** ./src/blocks/icon-link/styles/editor.scss ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/icon-link/styles/style.scss":
/*!************************************************!*\
  !*** ./src/blocks/icon-link/styles/style.scss ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/blocks/icon-link/block.json":
/*!*****************************************!*\
  !*** ./src/blocks/icon-link/block.json ***!
  \*****************************************/
/***/ ((module) => {
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"wc-booster/icon-link","version":"1.3","title":"Icon Link","description":"The Icon Link block adds visually appealing links with custom icons to your WordPress site, enhancing navigation and highlighting key content","attributes":{"block_id":{"type":"string"},"icon":{"type":"object","default":"fa-check"},"textColor":{"type":"string","default":"#000000"},"iconColor":{"type":"string","default":"#000000"},"title":{"type":"string"},"page":{"type":"number","default":""},"useExternalLink":{"type":"boolean","default":false},"externalLink":{"type":"string"},"iconSize":{"type":"object","default":{"activeUnit":"px","units":["px","em"],"range":{"min":1,"max":2000},"values":{"desktop":15,"tablet":15,"mobile":15}}},"textTypo":{"type":"object","default":{"fontFamily":"","fontSize":{"units":["px","em","rem"],"activeUnit":"px","values":{"desktop":15,"tablet":15,"mobile":15}},"fontWeight":400,"lineHeight":{"activeUnit":"","units":[""],"values":{"desktop":1,"tablet":1,"mobile":1}}}},"titleMargin":{"type":"object","default":{"activeUnit":"px","isLinkActive":false,"properties":["top","right","bottom","left"],"responsiveViews":["desktop","tablet","mobile"],"units":["px","rem"],"values":{"desktop":[0,0,0,5],"tablet":[0,0,0,5],"mobile":[0,0,0,5]}}}},"textdomain":"wc-booster","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		var installedChunks = {
/******/ 			"blocks/icon-link/index": 0,
/******/ 			"blocks/icon-link/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/icon-link/style-index"], () => (__webpack_require__("./src/blocks/icon-link/index.js")))
