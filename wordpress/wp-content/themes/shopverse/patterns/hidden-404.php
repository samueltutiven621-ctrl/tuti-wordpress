...
<h2 class="wp-block-heading has-text-align-center" style="font-size:200px"><?php echo esc_html__( '404', 'shopverse' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:heading {"textAlign":"center","level":3} -->
<h3 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'Page not found', 'shopverse' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'It looks like nothing was found at this location. Click button below to return to homepage.', 'shopverse' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-base-color has-primary-background-color has-text-color has-background has-link-color wp-element-button" href="<?php echo esc_url( home_url( '/' ));?>" style="border-radius:0px"><?php echo esc_html__( 'Back to Home', 'shopverse' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
